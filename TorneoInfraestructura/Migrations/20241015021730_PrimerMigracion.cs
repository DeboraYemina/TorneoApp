        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TiempoReaccion = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    Velocidad = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    Fuerza = table.Column<decimal>(type: "decimal(5,2)", nullable: true)
                },
                constraints: table =>
                {
